...
\section{First plots}
\subsection{Plot one: Boxplot of number of persons injured for 10 most common contributing factors in car accidents}

Figure \ref{fig:fig-1} describes the means, interquartile ranges, and outliers 
of the number of persons injured for each of the top 10 most common contributing
factors to car crashes for vehicle 1.
...
car_crashes[car_crashes$CONTRIBUTING.FACTOR.VEHICLE.1 %in% c("Illnes","Illness","Physical Disability"),]$CONTRIBUTING.FACTOR.VEHICLE.1 <- "Medical"
...
par(mar=c(10,5,2,2),xaxt="n",cex=0.5)
boxplot(car_crashes_top_factors$NUMBER.OF.PERSONS.INJURED ~ car_crashes_top_factors$CONTRIBUTING.FACTOR.VEHICLE.1,xlab="Contributing factor",ylab="Number of persons injured",main="Boxplot of number of persons injured for 10 most common contributing factors in car accidents")
