...
AND CAST(SUBSTR(CRASHDATE,-4) AS INT) >= 2020"
  ...
  ggplot(mydf) + aes(CONTRIBUTINGFACTORVEHICLE1, fill = VEHICLETYPECODE1) +
    ...
    scale_fill_manual(values = c("black", "purple", "blue","darkgreen")) +
                                          ggtitle("Top 5 Contributing Crash Factor with Top Vehicle Types after 2020")  + theme(axis.text.x = element_text(angle = 35, hjust=1))
  ...
  ggplot(mydf) + aes(CONTRIBUTINGFACTORVEHICLE1, fill = VEHICLETYPECODE1) +
    ...
    scale_fill_manual(values = c("black", "purple", "yellow", "green",
                                        "blue", "darkgreen")) +
                                          ggtitle("Top 5 Contributing Crash Factor with Top Vehicle Types before 2020")  + theme(axis.text.x = element_text(angle = 35, hjust=1))
